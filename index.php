        ...
        <table class=" table table-striped">
            ...
            <tbody>
                ...
                while($data = mysqli_fetch_array($mahasiswa)){
                    ...
                    <!-- mengirimkan id dari data  mahasiswa ke halaman edit  -->
                    <a href="edit.php?id=<?php echo $data['id']; ?>" class="btn btn-warning btn-sm text-white">Edit</href=>
                    <!-- Link untuk delete berdasarkan id, akan keluar confirm terlebih dahulu -->
                    <a href="delete.php?id=<?php echo $data['id']; ?>" class="btn btn-danger btn-sm"onclick="return corfirm('Anda Yakin Akan Menghapus Data Mahasiswa Ini?')">Hapus</a>
                    </td>
                    </tr>
                    <?php
                }
